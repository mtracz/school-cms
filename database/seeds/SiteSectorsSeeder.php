...
class SiteSectorsSeeder extends Seeder
{
    ...
    public function run()
    {
        $site_sectors = [
			...
			["id" => SiteSector::LEFT, "name" => "left", "panels_types_allowed_ids" => "1;2;5;6;7;", "is_menu_allowed" => 1, "orientation_id" => "2"],
			["id" => SiteSector::RIGHT, "name" => "right", "panels_types_allowed_ids" => "1;2;5;6;7;", "is_menu_allowed" => 1, "orientation_id" => "2"],
