...
class LayoutSeeder extends Seeder
{
    ...
    public function run() {
    	...
    	$elements = [
            ["id" => "1", "site_sector_id" => 3, "order" => 1, "panel_id" => null, "menu_id" => 1, "is_enabled" => 1],

            ["id" => "4", "site_sector_id" => 4, "order" => 1, "panel_id" => null, "menu_id" => 2, "is_enabled" => 1],

            ["id" => "5", "site_sector_id" => 4, "order" => 2, "panel_id" => null, "menu_id" => 3, "is_enabled" => 1],
    		["id" => "6", "site_sector_id" => 3, "order" => 2, "panel_id" => 3, "menu_id" => null, "is_enabled" => 1],
    		["id" => "7", "site_sector_id" => 4, "order" => 3, "panel_id" => 4, "menu_id" => null, "is_enabled" => 1],
            ...
            ["id" => "11", "site_sector_id" => 4, "order" => 4, "panel_id" => 8, "menu_id" => null, "is_enabled" => 1],
    	...
    	$menu_items = [
    		...
    		["id" => "6", "name" => "item22", "order" => 2, "menu_id" => 2, "is_dropdown" => 0],
    		["id" => "7", "name" => "item23", "order" => 3, "menu_id" => 2, "is_dropdown" => 0],
    	...
    	$links = [
            // menu główne
    		["id" => "1", "name" => "Strona główna", "url" => "http://sp9.legnica.pl", "order" => 1, "menu_item_id" => 1],
    		["id" => "2", "name" => "Dziennik", "url" => "https://uonetplus.vulcan.net.pl/Legnica", "order" => 2, "menu_item_id" => 2],
    		["id" => "3", "name" => "Plan lekcji", "url" => "http://sp9.legnica.pl/plan/index.html", "order" => 3, "menu_item_id" => 3],
    		["id" => "4", "name" => "Kontakt", "url" => "#", "order" => 4, "menu_item_id" => 5],
            // --
            // menu Szkoła
    		["id" => "5", "name" => "Archiwum", "url" => "http://www.sp9.legnica.pl/news_cats.php", "order" => 1, "menu_item_id" => 5],
            ["id" => "6", "name" => "Historia Szkoły", "url" => "http://www.sp9.legnica.pl/readarticle.php?article_id=1", "order" => 2, "menu_item_id" => 5],
            ["id" => "7", "name" => "Dokumenty", "url" => "http://www.sp9.legnica.pl/readarticle.php?article_id=7", "order" => 3, "menu_item_id" => 5],
            ["id" => "8", "name" => "Nauczyciele", "url" => "http://www.sp9.legnica.pl/readarticle.php?article_id=4", "order" => 4, "menu_item_id" => 5],
            ["id" => "9", "name" => "Raport z ewaluacji", "url" => "http://www.sp9.legnica.pl/readarticle.php?article_id=166", "order" => 5, "menu_item_id" => 5],
            ["id" => "10", "name" => "Kontakt", "url" => "http://www.sp9.legnica.pl/pages/kontakt", "order" => 6, "menu_item_id" => 5],
    		["id" => "11", "name" => "Monitoring", "url" => "http://www.sp9.legnica.pl/readarticle.php?article_id=184", "order" => 7, "menu_item_id" => 5],
            // --
    	...
    	$panels = [
    		["id" => "3", "name" => "banner_3", "header" => null, "content" => "<div id='main_banner'><img src='/images/banner/test_3.jpeg'></div>", "panel_type_id" => 2, "has_header" => 0],

    		["id" => "4", "name" => "info_1", "header" => "info_1", "content" => "<img src='/images/banner/test_1.jpeg'> <p> sample text </p>", "panel_type_id" => 4, "has_header" => 1],
    		["id" => "5", "name" => "info_2", "header" => "<strong>Operating Hours:</strong>", "content" => "<p><strong>Monday-Saturday:</strong><br/>8:00am–12:00am (EDT)<br/><strong>Sunday:</strong> <br/>9:00am–12:00am (EDT)<br/></p>", "panel_type_id" => 4, "has_header" => 1],
    		["id" => "6", "name" => "info_3", "header" => "info_3_header", "content" => "<h3> kek </h3><br/><p> asdasdadasd </p>", "panel_type_id" => 4, "has_header" => 1],
    		["id" => "7", "name" => "info_4", "header" => "info_4", "content" => "<p> asdasdasdadasdasdvSWZS45</p>", "panel_type_id" => 4, "has_header" => 1],

    		["id" => "8", "name" => "list_1", "header" => null, "content" => "<a> link </a></br><a> link </a></br><a> link </a></br><a> link </a></br>", "panel_type_id" => 5, "has_header" => 0],
            ["id" => "9", "name" => "google_map", "header" => null, "content" => '<iframe width="170" height="130" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.pl/maps?hl=pl&amp;lr=&amp;ie=UTF8&amp;q=sp+9+legnica&amp;fb=1&amp;split=1&amp;gl=pl&amp;cid=0,0,7333007650869757657&amp;ei=r_9NSuz9CpLm-Qbl6NCEBA&amp;source=embed&amp;ll=51.203562,16.14134&amp;spn=0.006295,0.006295&amp;output=embed"></iframe>', "panel_type_id" => 1, "has_header" => 0],
            ...
            ["id" => "14", "name" => "BIP", "header" => "BIP", "content" => '<a href="http://www.sp9.bip.legnica.eu"><img src="http://sp9.legnica.pl/images_old/bip.png"></a>', "panel_type_id" => 4, "has_header" => 1],
            ["id" => "15", "name" => "Legnica", "header" => "Legnica", "content" => '<a href="http://www.portal.legnica.eu/"><img src="http://sp9.legnica.pl/images/legnica2.png"></a>', "panel_type_id" => 4, "has_header" => 1],
