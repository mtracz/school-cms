...
class LayoutSeeder extends Seeder
{
    ...
    public function run() {
    	...
    	$links = [
            ...
            ["id" => "17", "name" => "Koła zainteresowań", "url" => "/readarticle.php?article_id=199", "order" => 4, "menu_item_id" => 8],
            ["id" => "18", "name" => "Strój ucznia (mundurki)", "url" => "/readarticle.php?article_id=103", "order" => 5, "menu_item_id" => 8],
            ["id" => "19", "name" => "Najzdolniejsi", "url" => "/readarticle.php?article_id=84", "order" => 6, "menu_item_id" => 8],
            ["id" => "20", "name" => "Samorząd uczniowski", "url" => "/readarticle.php?article_id=27", "order" => 7, "menu_item_id" => 8],
            ["id" => "21", "name" => "W-f dla kl. I-VI", "url" => "/readarticle.php?article_id=79", "order" => 8, "menu_item_id" => 8],
            ["id" => "22", "name" => "Podręczniki", "url" => "/Podreczniki_2017_2018.pdf", "order" => 9, "menu_item_id" => 8],
            ["id" => "23", "name" => "Gazetka szkolna", "url" => "http://www.juniormedia.pl/redakcje/panel/strzal-w-9", "order" => 10, "menu_item_id" => 8],
            // --
            // menu Rodzice
            ...
            ["id" => "36", "name" => "Dobry start w szkole", "url" => "/readarticle.php?article_id=129", "order" => 5, "menu_item_id" => 10],
            ["id" => "37", "name" => "Elementarz Korczaka", "url" => "/readarticle.php?article_id=136", "order" => 6, "menu_item_id" => 10],
            ["id" => "38", "name" => "Mały Mistrz", "url" => "/images_old/articles/2016_17/Maly_Mistrz.pdf", "order" => 7, "menu_item_id" => 10],
            ["id" => "39", "name" => "Mistrzowie Kodowania", "url" => "/readarticle.php?article_id=150", "order" => 8, "menu_item_id" => 10],
            ["id" => "40", "name" => "Pracownia Przyrodnicza", "url" => "/readarticle.php?article_id=122", "order" => 9, "menu_item_id" => 10],
            ["id" => "41", "name" => "Bezpiecznie Tu i Tam", "url" => "/readarticle.php?article_id=183", "order" => 10, "menu_item_id" => 10],
            // --
            // Mapa strony
