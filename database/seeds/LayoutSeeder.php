...
class LayoutSeeder extends Seeder
{
    ...
    public function run() {
    	...
    	$links = [
            ...
            // --
            // menu Szkoła
    		["id" => "5", "name" => "Archiwum", "url" => "news_cats.php", "order" => 1, "menu_item_id" => 5],
            ...
            ["id" => "17", "name" => "Klub Młodego Europejczka", "url" => "", "order" => 4, "menu_item_id" => 8],
            ["id" => "18", "name" => "Koła zainteresowań", "url" => "readarticle.php?article_id=199", "order" => 5, "menu_item_id" => 8],
            ["id" => "19", "name" => "Strój ucznia (mundurki)", "url" => "readarticle.php?article_id=103", "order" => 6, "menu_item_id" => 8],
            ["id" => "20", "name" => "Najzdolniejsi", "url" => "readarticle.php?article_id=84", "order" => 7, "menu_item_id" => 8],
            ["id" => "21", "name" => "Samorząd uczniowski", "url" => "readarticle.php?article_id=27", "order" => 8, "menu_item_id" => 8],
            ["id" => "22", "name" => "W-f dla kl. I-VI", "url" => "readarticle.php?article_id=79", "order" => 9, "menu_item_id" => 8],
            ["id" => "23", "name" => "Podręczniki", "url" => "Podreczniki_2017_2018.pdf", "order" => 10, "menu_item_id" => 8],
            ["id" => "24", "name" => "Gazetka szkolna", "url" => "", "order" => 11, "menu_item_id" => 8],
            // --
            // menu Rodzice
            ["id" => "25", "name" => "Elementarz", "url" => "readarticle.php?article_id=165", "order" => 1, "menu_item_id" => 9],
            ["id" => "26", "name" => "Kalendarium", "url" => "readarticle.php?article_id=82", "order" => 2, "menu_item_id" => 9],
            ["id" => "27", "name" => "Obiady", "url" => "readarticle.php?article_id=164", "order" => 3, "menu_item_id" => 9],
            ["id" => "28", "name" => "Procedury odbierania uczniów", "url" => "Procedura.pdf", "order" => 4, "menu_item_id" => 9],
            ["id" => "29", "name" => "Rada Rodziców", "url" => "readarticle.php?article_id=156", "order" => 5, "menu_item_id" => 9],
            ["id" => "30", "name" => "Rekolekcje", "url" => "", "order" => 6, "menu_item_id" => 9],
            ["id" => "31", "name" => "Wyposażenie pierwszoklasisty", "url" => "readarticle.php?article_id=178", "order" => 7, "menu_item_id" => 9],
            ["id" => "32", "name" => "Pedagog i psycholog", "url" => "readarticle.php?article_id=163", "order" => 8, "menu_item_id" => 9],
            // --
            // menu Projekty i certyfikaty
            ["id" => "33", "name" => "Junior Media", "url" => "readarticle.php?article_id=180", "order" => 1, "menu_item_id" => 10],
            ["id" => "34", "name" => "Szkoła Bez Przemocy", "url" => "readarticle.php?article_id=105", "order" => 2, "menu_item_id" => 10],
            ["id" => "35", "name" => "Szkoła w pilotarzu Progr4mowanie", "url" => "", "order" => 3, "menu_item_id" => 10],
            ["id" => "36", "name" => "Akademia Przyjaciół Pszczół", "url" => "readarticle.php?article_id=151", "order" => 4, "menu_item_id" => 10],
            ["id" => "37", "name" => "Dzień Bezpiecznego Internetu", "url" => "", "order" => 5, "menu_item_id" => 10],
            ["id" => "38", "name" => "Dobry start w szkole", "url" => "readarticle.php?article_id=129", "order" => 6, "menu_item_id" => 10],
            ["id" => "39", "name" => "Elementarz Korczaka", "url" => "readarticle.php?article_id=136", "order" => 7, "menu_item_id" => 10],
            ["id" => "40", "name" => "Mały Mistrz", "url" => "images_old/articles/2016_17/Maly_Mistrz.pdf", "order" => 8, "menu_item_id" => 10],
            ["id" => "41", "name" => "Mistrzowie Kodowania", "url" => "readarticle.php?article_id=150", "order" => 9, "menu_item_id" => 10],
            ["id" => "42", "name" => "Pracownia Przyrodnicza", "url" => "readarticle.php?article_id=122", "order" => 9, "menu_item_id" => 10],
            ["id" => "43", "name" => "Bezpiecznie Tu i Tam", "url" => "readarticle.php?article_id=183", "order" => 9, "menu_item_id" => 10],
            ["id" => "44", "name" => "# Super koderzy", "url" => "", "order" => 9, "menu_item_id" => 10],
            // --
            // Mapa strony
            ["id" => "45", "name" => "Mapa strony", "url" => "sitemap", "order" => 1, "menu_item_id" => 11],
            // --
    	];
